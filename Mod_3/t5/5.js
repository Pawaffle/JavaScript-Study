...
// add your code here
const targetElement = document.querySelector('#pictures')
...
for ( let object of picArray) {
  ...
  paragaph.textContent = object.description

  article.append(header, figure, paragaph)
...
<article class="card">
   <h2>${object.title}</h2>
   <figure>
      <img src=${object.image.medium} alt=${object.title}>
      <figcaption>${object.caption}</figcaption>
   </figure>
   <p>${object.description}</p>
</article>
`
  targetElement.innerHTML += newArticle
}
 */